...
data.waveheading            = data.raw.waveDirection;
data.wavenumber             = data.raw.wavenumber;
...
if simu.hydrocoupling == 1
    data.fDamping          = data.raw.fDamping      (rowColStart:rowColEnd,1:end,:);
    data.fAddedMass        = data.raw.fAddedMass    (rowColStart:rowColEnd,1:end,:);
    data.fAddedMassInf     = data.raw.fAddedMassInf (rowColStart:rowColEnd,1:end,:);
    data.fAddedMassZero    = data.raw.fAddedMassZero(rowColStart:rowColEnd,1:end,:);
else
