...
for i=1:L
    ...
    eval(['output.bodies(' num2str(i) ').forceRadiationDamping = '... 
        body(i).hydroData.properties.name '_out.signals.values(:,31:36);']);
    eval(['output.bodies(' num2str(i) ').forceAddedMass = '... 
    ...
    eval(['output.bodies(' num2str(i) ').forceLinearDamping = '... 
        body(i).hydroData.properties.name '_out.signals.values(:,55:60);']);
    eval(['output.bodies(' num2str(i) ').forceMooring = '... 
        body(i).hydroData.properties.name '_out.signals.values(:,61:66);']);
