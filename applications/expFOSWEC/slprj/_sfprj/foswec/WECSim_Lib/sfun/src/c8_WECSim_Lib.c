...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3622057830U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2034337519U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(707526963U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2653150873U);
}
...
static void mdlSetWorkWidths_c8_WECSim_Lib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2439470347U));
  ssSetChecksum1(S,(1353354500U));
  ssSetChecksum2(S,(1766306579U));
  ssSetChecksum3(S,(3261185354U));
