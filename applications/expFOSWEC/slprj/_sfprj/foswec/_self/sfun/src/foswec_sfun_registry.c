...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_foswec_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_WECSim_Lib_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "foswec") == 0) {
    sf_foswec_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }

  if (strcmp(machineName, "WECSim_Lib") == 0) {
    sf_WECSim_Lib_uses_exported_functions(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
unsigned int sf_process_testpoint_info_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_process_testpoint_info_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_process_testpoint_info_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_foswec_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_autoinheritance_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "foswec") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_foswec_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "WECSim_Lib") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_WECSim_Lib_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_third_party_uses_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_third_party_uses_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_third_party_uses_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "foswec") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_foswec_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "WECSim_Lib") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_WECSim_Lib_third_party_uses_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_jit_fallback_info_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_jit_fallback_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_jit_fallback_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "foswec") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_foswec_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "WECSim_Lib") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_WECSim_Lib_jit_fallback_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_updateBuildInfo_args_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_updateBuildInfo_args_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_updateBuildInfo_args_info( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "foswec") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_foswec_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
  ...
  if (strcmp(machineName, "WECSim_Lib") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_WECSim_Lib_updateBuildInfo_args_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_foswec_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_WECSim_Lib_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "foswec") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_foswec_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "WECSim_Lib") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_WECSim_Lib_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
unsigned int sf_process_get_post_codegen_info(int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[])
{
  extern void sf_foswec_get_post_codegen_info( int nlhs, mxArray * plhs[], int
    nrhs, const mxArray * prhs[] );
  extern void sf_WECSim_Lib_get_post_codegen_info( int nlhs, mxArray * plhs[],
    int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  machineName[(sizeof(machineName)/sizeof(char)-1)] = '\0';
  if (strcmp(machineName, "foswec") == 0) {
    sf_foswec_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }

  if (strcmp(machineName, "WECSim_Lib") == 0) {
    sf_WECSim_Lib_get_post_codegen_info(nlhs, plhs, nrhs-2, prhs+2);
    return 1;
  }
...
extern unsigned int sf_foswec_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_WECSim_Lib_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
  ...
  method, void *data)
{
  if (!strcmp(machineName,"foswec")) {
    return(sf_foswec_method_dispatcher(simstructPtr,chartFileNumber,specsCksum,
            method,data));
  }

  if (!strcmp(machineName,"WECSim_Lib")) {
    return(sf_WECSim_Lib_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void foswec_initializer(void);
extern void WECSim_Lib_initializer(void);
extern void foswec_register_exported_symbols(SimStruct* S);
extern void WECSim_Lib_register_exported_symbols(SimStruct* S);
extern void foswec_debug_initialize(struct SfDebugInstanceStruct*);
extern void WECSim_Lib_debug_initialize(struct SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  foswec_register_exported_symbols(S);
  WECSim_Lib_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      foswec_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    foswec_initializer();
    if (!simModeIsRTWGen) {
      WECSim_Lib_debug_initialize(sfGlobalDebugInstanceStruct);
    }

    WECSim_Lib_initializer();
  }
