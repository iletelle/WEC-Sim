...
%%
save(['RW_T_',num2str(10*waves.T),'_A_',num2str(10*waves.H),'_3DOF_Float_Convcalc_',num2str(simu.convCalc)],'body','constraint','output','simu','waves')%,'pto')
% logpow = log10(pto.c);
% save(['RW_T_',num2str(10*waves.T),'_A_',num2str(10*waves.H),'_Bg_',num2str(logpow)],'body','constraint','output','simu','waves','pto')
end
%% Post-Process Data
Tshift=-2;
% Body 1
