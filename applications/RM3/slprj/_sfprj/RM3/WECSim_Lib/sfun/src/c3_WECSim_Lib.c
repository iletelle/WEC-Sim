...
static void c3_c_emlrt_marshallIn(SFc3_WECSim_LibInstanceStruct *chartInstance,
  const mxArray *c3_b_velocity, const char_T *c3_identifier, real_T c3_y[3606]);
static void c3_d_emlrt_marshallIn(SFc3_WECSim_LibInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[3606]);
...
static void c3_h_emlrt_marshallIn(SFc3_WECSim_LibInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[601]);
  ...
  chartInstance)
{
  ...
  for (c3_i0 = 0; c3_i0 < 6; c3_i0++) {
    c3_u[c3_i0] = (*chartInstance->c3_F_FM)[c3_i0];
  }
  ...
  for (c3_i1 = 0; c3_i1 < 3606; c3_i1++) {
    c3_c_u[c3_i1] = chartInstance->c3_velocity[c3_i1];
  }
  ...
  if (!chartInstance->c3_velocity_not_empty) {
    ...
    sf_mex_assign(&c3_d_y, sf_mex_create("y", c3_c_u, 0, 0U, 1U, 0U, 2, 6, 601),
                  false);
  }
  ...
  *chartInstance)
{
  ...
  real_T c3_b_v[6];
  int32_T c3_i10;
  real_T c3_b_ZeroVel[3606];
  int32_T c3_i11;
  int32_T c3_i12;
  real_T c3_b_CTTime[601];
  ...
  int32_T c3_i24;
  int32_T c3_i25;
  real_T c3_c_CTTime[601];
  int32_T c3_i26;
  real_T c3_b_tmpY[601];
  int32_T c3_d_kd;
  int32_T c3_i27;
  real_T c3_b_tmpF[6];
  int32_T c3_i28;
  ...
  if (CV_EML_IF(0, 1, 0, CV_RELATIONAL_EVAL(4U, 0U, 0, c3_b_check, 10.0, -1, 0U,
    ...
    if (CV_EML_IF(0, 1, 1, !chartInstance->c3_velocity_not_empty)) {
      ...
      for (c3_i14 = 0; c3_i14 < 3606; c3_i14++) {
      ...
      if (CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 1, c3_int2, 1.0E-8, -1,
        ...
        c3_i15 = 0;
        for (c3_i16 = 0; c3_i16 < 600; c3_i16++) {
        ...
        c3_i18 = 0;
        for (c3_i19 = 0; c3_i19 < 600; c3_i19++) {
    ...
    while (c3_b_kd < 6) {
      ...
      while (c3_b_kk < 6) {
        ...
        for (c3_i24 = 0; c3_i24 < 601; c3_i24++) {
          c3_tmpY[c3_i24] = chartInstance->c3_IRKB[(c3_i24 + 601 * c3_c_kd) +
            3606 * c3_c_kk] * chartInstance->c3_velocity[c3_d_kk + 6 * c3_i24];
        }

        _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 28);
        for (c3_i25 = 0; c3_i25 < 601; c3_i25++) {
          c3_c_CTTime[c3_i25] = c3_b_CTTime[c3_i25];
        }

        for (c3_i26 = 0; c3_i26 < 601; c3_i26++) {
  ...
  *c3_b_inData)
{
  ...
  c3_mxArrayOutData = NULL;
  c3_i30 = 0;
  for (c3_i31 = 0; c3_i31 < 601; c3_i31++) {
    for (c3_i32 = 0; c3_i32 < 6; c3_i32++) {
      c3_c_inData[c3_i32 + c3_i30] = (*(real_T (*)[3606])c3_b_inData)[c3_i32 +
        c3_i30];
    }
  ...
  c3_i33 = 0;
  for (c3_i34 = 0; c3_i34 < 601; c3_i34++) {
    for (c3_i35 = 0; c3_i35 < 6; c3_i35++) {
      c3_u[c3_i35 + c3_i33] = c3_c_inData[c3_i35 + c3_i33];
    }
  ...
  if (!chartInstance->c3_velocity_not_empty) {
    ...
    sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 2, 6, 601),
                  false);
  }
  ...
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[3606])
{
  ...
  if (mxIsEmpty(c3_u)) {
    ...
    chartInstance->c3_velocity_not_empty = true;
    sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv3, 1, 0, 0U, 1, 0U, 2, 6,
                  601);
    for (c3_i36 = 0; c3_i36 < 3606; c3_i36++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  sf_mex_destroy(&c3_b_velocity);
  c3_i37 = 0;
  for (c3_i38 = 0; c3_i38 < 601; c3_i38++) {
    for (c3_i39 = 0; c3_i39 < 6; c3_i39++) {
      (*(real_T (*)[3606])c3_outData)[c3_i39 + c3_i37] = c3_y[c3_i39 + c3_i37];
    }
  ...
  *c3_b_inData)
{
  ...
  for (c3_i41 = 0; c3_i41 < 6; c3_i41++) {
    c3_u[c3_i41] = c3_c_inData[c3_i41];
  }
  ...
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[6])
{
  ...
  int32_T c3_i42;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv4, 1, 0, 0U, 1, 0U, 1, 6);
  ...
  *c3_b_inData)
{
  ...
  chartInstance = (SFc3_WECSim_LibInstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i44 = 0; c3_i44 < 601; c3_i44++) {
    c3_c_inData[c3_i44] = (*(real_T (*)[601])c3_b_inData)[c3_i44];
  }

  for (c3_i45 = 0; c3_i45 < 601; c3_i45++) {
    c3_u[c3_i45] = c3_c_inData[c3_i45];
  }

  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 1, 601), false);
  sf_mex_assign(&c3_mxArrayOutData, c3_y, false);
  return c3_mxArrayOutData;
}
  ...
  *c3_b_inData)
{
  ...
  for (c3_i47 = 0; c3_i47 < 6; c3_i47++) {
    ...
    for (c3_i49 = 0; c3_i49 < 6; c3_i49++) {
      for (c3_i50 = 0; c3_i50 < 601; c3_i50++) {
        chartInstance->c3_inData[(c3_i50 + c3_i48) + c3_i46] = (*(real_T (*)
          [21636])c3_b_inData)[(c3_i50 + c3_i48) + c3_i46];
      }
  ...
  for (c3_i52 = 0; c3_i52 < 6; c3_i52++) {
    ...
    for (c3_i54 = 0; c3_i54 < 6; c3_i54++) {
      for (c3_i55 = 0; c3_i55 < 601; c3_i55++) {
        c3_u[(c3_i55 + c3_i53) + c3_i51] = chartInstance->c3_inData[(c3_i55 +
          c3_i53) + c3_i51];
      }
  ...
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 3, 601, 6, 6),
                false);
  sf_mex_assign(&c3_mxArrayOutData, c3_y, false);
  return c3_mxArrayOutData;
}
  ...
  *c3_b_inData)
{
  ...
  c3_mxArrayOutData = NULL;
  c3_i56 = 0;
  for (c3_i57 = 0; c3_i57 < 601; c3_i57++) {
    for (c3_i58 = 0; c3_i58 < 6; c3_i58++) {
      c3_c_inData[c3_i58 + c3_i56] = (*(real_T (*)[3606])c3_b_inData)[c3_i58 +
        c3_i56];
    }
  ...
  c3_i59 = 0;
  for (c3_i60 = 0; c3_i60 < 601; c3_i60++) {
    for (c3_i61 = 0; c3_i61 < 6; c3_i61++) {
      c3_u[c3_i61 + c3_i59] = c3_c_inData[c3_i61 + c3_i59];
    }
  ...
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_create("y", c3_u, 0, 0U, 1U, 0U, 2, 6, 601), false);
  sf_mex_assign(&c3_mxArrayOutData, c3_y, false);
  return c3_mxArrayOutData;
}
  ...
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[601])
{
  ...
  int32_T c3_i62;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv5, 1, 0, 0U, 1, 0U, 1, 601);
  for (c3_i62 = 0; c3_i62 < 601; c3_i62++) {
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  for (c3_i63 = 0; c3_i63 < 601; c3_i63++) {
    (*(real_T (*)[601])c3_outData)[c3_i63] = c3_y[c3_i63];
  }
  ...
  *c3_b_inData)
{
  ...
  for (c3_i68 = 0; c3_i68 < 6; c3_i68++) {
    for (c3_i69 = 0; c3_i69 < 6; c3_i69++) {
      c3_u[c3_i69 + c3_i67] = c3_c_inData[c3_i69 + c3_i67];
    }
  ...
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[36])
{
  ...
  int32_T c3_i70;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv6, 1, 0, 0U, 1, 0U, 2, 6, 6);
  ...
  c3_x[601], real_T c3_y[601])
{
  ...
  real_T c3_d_x;
  real_T c3_b_z;
  for (c3_i74 = 0; c3_i74 < 601; c3_i74++) {
    c3_b_x[c3_i74] = c3_x[c3_i74];
  }

  c3_intmin(chartInstance);
  for (c3_i = 1; c3_i < 601; c3_i++) {
    c3_b_i = c3_i;
    c3_b_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c3_b_i), 1, 601, 1, 0) - 1] = c3_b_x[_SFD_EML_ARRAY_BOUNDS_CHECK(
      "", (int32_T)_SFD_INTEGER_CHECK("", (real_T)(c3_b_i + 1)), 1, 601, 1, 0) -
      1] - c3_b_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
      (real_T)c3_b_i), 1, 601, 1, 0) - 1];
  }
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_F_FM = (real_T (*)[6])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c3_ZeroVel = (real_T (*)[3606])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c3_b_IRKB = (real_T (*)[21636])ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c3_CTTime = (real_T (*)[601])ssGetInputPortSignal_wrapper
    (chartInstance->S, 4);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3388552964U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2180929908U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(444775461U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3694378650U);
}
...
static void mdlSetWorkWidths_c3_WECSim_Lib(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3089955240U));
  ssSetChecksum1(S,(295452206U));
  ssSetChecksum2(S,(1082283345U));
  ssSetChecksum3(S,(1605165498U));
